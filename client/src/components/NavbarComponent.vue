...
const routes = router.getRoutes().filter(route => route.meta.navbar === true);
</script>

<template>
  <nav class="sticky top-0 left-0 z-50 w-full border-b border-gray-200 bg-white dark:border-gray-600 dark:bg-gray-900">
      ...
      <div class="flex items-center md:order-2">
        <button type="button" data-dropdown-toggle="language-dropdown-menu"
          ...
          <svg class="mr-2 h-5 w-5 rounded-full" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
               id="flag-icons-cz" viewBox="0 0 512 512">
          ...
          <ul class="py-2 font-medium" role="none">
            <li>
              <a href="#"
                ...
                <div class="inline-flex items-center">
                  <svg class="mr-2 rounded-full h-3.5 w-3.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                       id="flag-icons-cz" viewBox="0 0 512 512">
                    <path fill="#fff" d="M0 0h512v256H0z"/>
                    <path fill="#d7141a" d="M0 256h512v256H0z"/>
                    <path fill="#11457e" d="M300 256 0 56v400z"/>
            ...
            <li>
              <a href="#"
                 ...
                 role="menuitem">
                <div class="inline-flex items-center">
                  <svg aria-hidden="true" class="mr-2 rounded-full h-3.5 w-3.5" xmlns="http://www.w3.org/2000/svg"
